...
public class GetVideosFromListComandoTest {

    @Test
    public void execute() throws VIUCABException, SQLException {

        Entity est = EntityFactory.getVideosFromList(60);

        GetListaDeReproduccionDao dao =  DaoFactory.instanciateDaoListaDeReproduccion(); //instancio DAO
        ArrayList<Entity> resultadoPrueba = dao.GetVideosFromList(est); //llamo al metodo y obtengo el resultado
