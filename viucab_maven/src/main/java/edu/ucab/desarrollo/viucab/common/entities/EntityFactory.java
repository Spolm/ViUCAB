...
public class EntityFactory
{
    ...
    static public Entity instantiateVideo(){ return new Video();}

    static public Entity instantiateVideo(String titulo, String descripcion,String imgUrl, String url, int usuario ){
